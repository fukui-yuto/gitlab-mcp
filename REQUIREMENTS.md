...
| 31 | `get_wiki_page` | Wikiページ取得 | `GET /projects/:id/wikis/:slug` |
| 32 | `update_wiki_page` | Wikiページ更新 | `PUT /projects/:id/wikis/:slug` |
| 33 | `delete_wiki_page` | Wikiページ削除 | `DELETE /projects/:id/wikis/:slug` |

### グループ / フォーク（2ツール） — `src/tools/groups.ts`

| # | ツール名 | 説明 | GitLab API |
|---|---------|------|-----------|
| 34 | `fork_project` | プロジェクトフォーク | `POST /projects/:id/fork` |
| 35 | `list_group_projects` | グループ内プロジェクト一覧 | `GET /groups/:id/projects` |
