...
### Merge Request（8） — `merge-requests.ts`
...
│       ├── issues.ts         # Issue (6)
│       ├── merge-requests.ts # Merge Request (8)
│       ├── repository.ts     # リポジトリ (11)
